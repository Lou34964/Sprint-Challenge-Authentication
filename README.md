...
Sessions used to provide persistant data for request.

- [ ] What does bcrypt do to help us store passwords in a secure manner? 
bcrypt creates a hash of a password so you don't have to store the actual password.

- [ ] What does bcrypt do to slow down attackers? 
An attacker would have to sit there and brute force for quite a while to decrypt a hash... 
